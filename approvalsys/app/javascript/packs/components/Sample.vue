                  ...
                  <ul class="contacts-list">
                    ...
                    <li>
                      <a href="#">
                        <img
                          class="contacts-list-img"
                          src="~admin-lte/dist/img/user7-128x128.jpg"
                          alt="User Image"
                        >
                    ...
                    <li>
                      <a href="#">
                        <img
                          class="contacts-list-img"
                          src="~admin-lte/dist/img/user6-128x128.jpg"
                          alt="User Image"
                        >
                    ...
                    <li>
                      <a href="#">
                        <img
                          class="contacts-list-img"
                          src="~admin-lte/dist/img/user8-128x128.jpg"
                          alt="User Image"
                        >
            ...
            <row>
              ...
              <div class="col-md-4">
                <ul class="chart-legend clearfix">
                  <li>
                    <i class="fa fa-circle-o text-red"></i> Chrome
                  </li>
                  <li>
                    <i class="fa fa-circle-o text-green"></i> IE
                  </li>
                  <li>
                    <i class="fa fa-circle-o text-yellow"></i> FireFox
                  </li>
                  <li>
                    <i class="fa fa-circle-o text-aqua"></i> Safari
                  </li>
                  <li>
