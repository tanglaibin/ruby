<template>
  <div>
    <div class="box box-default color-palette-box">
      ...
      <div class="box-body">
        <row>
          <va-color-palette-set v-for="(color, index) in colors[0]" :key="index" :color="color"></va-color-palette-set>
        </row>
        <!-- /.row -->
        <row>
          <va-color-palette-set v-for="(color, index) in colors[1]" :key="index" :color="color"></va-color-palette-set>
        </row>
        <!-- /.row -->
      </div>
    </div>
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            <va-alert type="info" :dismissible="true">
              ...
              <div slot="body">Info alert preview. This alert is dismissable.</div>
            </va-alert>
            <va-alert type="warning" :dismissible="true">
              ...
              <div slot="body">Warning alert preview. This alert is dismissable.</div>
            </va-alert>
            <va-alert type="success" :dismissible="true">
              ...
              <div slot="body">Success alert preview. This alert is dismissable.</div>
            </va-alert>
          </div>
          <!-- /.box-body -->
        </div>
    ...
    <row>
      ...
      <div class="col-md-6">
        <va-custom-tab tabsClass="pull-right">
          <li slot="nav" class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
              Dropdown
              <span class="caret"></span>
          ...
          <li slot="nav" class="pull-left header">
    ...
    <row>
      <div class="col-md-6">
        <va-box title="Progress Bars Different Sizes" :isSolid="true" widgetType>
          <div slot="content">
            <p>
              <code>.progress</code>
            </p>
            <va-progress-bar type="primary" :max="100" :value="40" text="40% Complete (success)"></va-progress-bar>
      ...
      <div class="col-md-6">
        <va-box title="Progress bars" :isSolid="true" widgetType>
          <div slot="content">
            <va-progress-bar
              type="green"
              :isStriped="false"
    ...
    <row>
      <div class="col-md-6">
        <va-box title="Vertical Progress Bars Different Sizes" :isSolid="true" widgetType>
      ...
      <div class="col-md-6">
        <va-box title="Vertical Progress bars" :isSolid="true" widgetType>
          <div slot="content" class="text-center">
            <p>
              By adding the class
    ...
    <row>
      <div class="col-md-6">
        <va-box title="Collapsible Accordion" :isSolid="true" widgetType>
          <div slot="content" class="text-center">
            <va-accordion :list="accordion.list"></va-accordion>
          </div>
        </va-box>
      </div>

      <div class="col-md-6">
        <va-box title="Carousel" :isSolid="true" widgetType>
          <div slot="content">
            <va-carousel :name="carousel.name" :list="carousel.list"></va-carousel>
          </div>
        </va-box>
      </div>
    </row>
    ...
    <row>
      <div class="col-md-6">
        <va-box title="Headlines" :isSolid="true" widgetType>
      ...
      <div class="col-md-6">
        <va-box title="Text Emphasis" :isSolid="true" widgetType>
          <i slot="icon-title" class="fa fa-text-width"></i>

          <div slot="content">
            <va-text>Lead to emphasize importance</va-text>

            <va-text type="green">Text green to emphasize success</va-text>

            <va-text type="aqua">Text aqua to emphasize info</va-text>

            <va-text type="light-blue">Text light blue to emphasize info (2)</va-text>

            <va-text type="red">Text red to emphasize danger</va-text>

            <va-text type="yellow">Text yellow to emphasize warning</va-text>
    ...
    <row>
      <div class="col-md-6">
        <va-box title="Block Quotes" :isSolid="true" widgetType>
          <i slot="icon-title" class="fa fa-text-width"></i>
      ...
      <div class="col-md-6">
        <va-box title="Block Quotes Pulled Right" :isSolid="true" widgetType>
          <i slot="icon-title" class="fa fa-text-width"></i>
    ...
    <row>
      <div class="col-md-4">
        <va-box title="Unordered Lists" :isSolid="true" widgetType>
          <i slot="icon-title" class="fa fa-text-width"></i>
      ...
      <div class="col-md-4">
        <va-box title="Ordered Lists" :isSolid="true" widgetType>
          <i slot="icon-title" class="fa fa-text-width"></i>
      ...
      <div class="col-md-4">
        <va-box title="Unstyled Lists" :isSolid="true" widgetType>
          <i slot="icon-title" class="fa fa-text-width"></i>
    ...
    <row>
      <div class="col-md-6">
        <va-box title="Description" :isSolid="true" widgetType>
          <i slot="icon-title" class="fa fa-text-width"></i>
      ...
      <div class="col-md-6">
        <va-box title="Description Horizontal" :isSolid="true" widgetType>
          <i slot="icon-title" class="fa fa-text-width"></i>
